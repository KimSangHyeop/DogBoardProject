	...
	<div class="container">
		...
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top: 40px;">
				<form method="post" action="./custo.do?command=searchPass">
					<!-- 로그인 액션으로 로그인 정보 보내기 -->
					...
					<div class="form-group">
						<input type="text" class="form-control" placeholder="전화번호 ' - ' 없이 입력해주세요."
							name="telNum" maxlength="11">
						<!--  길이 제한 -->
					</div>
					<div>
						<h6 style="color: red;" align="center"><%=request.getAttribute("msg") %></h6>
					</div>
				...
				<div align="center">
					<p><a href="./Customer/CustomerJoin.jsp">회원가입</a> / <a href="./Customer/searchId.jsp">아이디 찾기</a>
				</div>
			</div>
		</div>
	</div>
