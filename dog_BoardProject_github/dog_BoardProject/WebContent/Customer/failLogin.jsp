	...
	<div class="container">
		...
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top: 40px">
				<form method="post" action="./custo.do?command=login">
					<!-- 로그인 액션으로 로그인 정보 보내기 -->
					<h3 style="text-align: center;">로 그 인</h3>
					<!-- 문장 가운데 정렬 -->
					<div class="form-group">
						<input type="text" class="form-control"
							name="userid" maxlength="20" placeholder="아이디">
						<!-- 아이디 길이 제한 -->
					</div>
				...
				<button class="form-control" onclick="location='CustomerJoin.jsp'">회 원 가 입</button>
				<div align="center">
